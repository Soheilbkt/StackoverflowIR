...
export default function Popup({isstatus:isAcivte,onchancge:IsShowmodal}:PopuptypeProps) {
...
<div id="popup-modal"  className={`${isAcivte ? "flex" : "hidden"} overflow-y-auto   fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full`}>
    <div className="relative p-4 w-full max-w-md max-h-full">
        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div className="p-4 md:p-5 text-center">
                ...
                <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">به دلیل تحریم بودن سرور های فایربیس 
                حتما از Vpn یا dns استفاده کنید(:</h3>
                <button
                onClick={IsShowmodal} 
