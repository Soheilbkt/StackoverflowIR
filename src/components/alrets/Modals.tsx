...
import { createTodo } from '../../features/Apidatas';
...
export const Modals: FC<ModalsProps> = ({ clicShow }) => {
  const data = useSelector((state: any) => state.data);
  const idnewUSers: number = Object.values(data.data).length + 1;
